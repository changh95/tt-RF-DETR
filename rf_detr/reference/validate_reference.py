...
_DATA_DIR = os.environ.get("TT_RF_DETR_DATA", os.path.join(_REPO_ROOT, "data"))
IMAGE_PATH = os.environ.get(
    "TT_RF_DETR_IMAGE", os.path.join(_DATA_DIR, "cats_000000039769.jpg")
)
OUTPUT_PATH = os.environ.get(
    "TT_RF_DETR_ORACLE", os.path.join(_DATA_DIR, "reference_outputs.pt")
)
CONF_THRESHOLD = 0.5
